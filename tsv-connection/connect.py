...
representation_folder_path = '/home/kuzhum/IASA/IASA-Final-Vlad/results/gpt4_test'
tsv_folder_path = '/home/kuzhum/IASA/IASA-Final-Vlad/IASA_Champ_Final/app_data_splitted/test'

result_folder = "/home/kuzhum/IASA/IASA-Final-Vlad/results/gpt4_test_tsv"

CONNECTION_PROMPT = "Here is the representation of the same UI elements. It has additional information, as coordinates of the elements. You can use this information to connect the representation with the UI elements."
